...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="icon" href="{{asset(env('THEME'))}}/images/favicon/favicon.png" sizes="32x32" />
    <link rel="icon" href="{{asset(env('THEME'))}}/images/favicon/favicon.png" sizes="192x192" />
    <link rel="apple-touch-icon" href="{{asset(env('THEME'))}}/images/favicon/favicon.png" />
    <meta name="msapplication-TileImage" content="{{asset(env('THEME'))}}/images/favicon/favicon.png" />
    <!-- Structured Data  -->
    ...
    <!-- <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/vendor/simple-line-icons.css" />
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/vendor/ionicons.min.css" /> -->

    <!-- plugins css (All Plugins Files) -->
    <!-- <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/animate.css" />
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/swiper-bundle.min.css" />
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/jquery-ui.min.css" />
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/jquery.lineProgressbar.css">
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/nice-select.css" />
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/venobox.css" /> -->

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="{{asset(env('THEME'))}}/css/plugins/plugins.min.css" />
                    ...
                    <div class="col d-none d-lg-block">
                        <div class="header-top-set-lan-curr d-flex justify-content-end">
                            ...
                            <div class="header-top-curr dropdown">
                                <button class="dropdown-toggle" data-bs-toggle="dropdown"> Мова :  Українська<i
                                        class="ion-ios-arrow-down"></i></button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="dropdown-item" href="#">Український</a></li>
                ...
                <div class="row align-self-center">
                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{asset(env('THEME'))}}/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
        ...
        <div class="header-bottom d-lg-none sticky-nav bg-white">
            <div class="container position-relative">
                <div class="row align-self-center">
                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{asset(env('THEME'))}}/images/logo/logo3.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset(env('THEME'))}}/images/product-image/1.jpg" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset(env('THEME'))}}/images/product-image/2.jpg" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset(env('THEME'))}}/images/product-image/3.jpg" alt="Cart product Image"></a>
                        <div class="content">
            ...
            <div class="offcanvas-userpanel mt-8">
                <ul>
                    ...
                    <li class="offcanvas-userpanel__role">
                        <a href="#">Український <i class="ion-ios-arrow-down"></i></a>
                        <ul class="user-sub-menu">
                            <li><a class="current" href="#">Український</a></li>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="hero-slide-item slider-height-2 swiper-slide d-flex">
                    <div class="hero-bg-image">
                        <img src="{{asset(env('THEME'))}}/images/slider-image/slider-2-1.jpg" alt="">
                    </div>
                ...
                <div class="hero-slide-item slider-height-2 swiper-slide d-flex text-center">
                    <div class="hero-bg-image">
                        <img src="{{asset(env('THEME'))}}/images/slider-image/slider-2-2.jpg" alt="">
                    </div>
                    <div class="container align-self-center">
                        <div class="row justify-content-center">
                            <div class="col-md-8 offset-2 align-self-center m-auto">
            ...
            <div class="category-slider swiper-container" data-aos="fade-up">
                <div class="category-wrapper swiper-wrapper">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="{{asset(env('THEME'))}}/images/icons/1.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="{{asset(env('THEME'))}}/images/icons/2.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="{{asset(env('THEME'))}}/images/icons/3.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="{{asset(env('THEME'))}}/images/icons/4.png" alt="">
                    ...
                    <div class="swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="{{asset(env('THEME'))}}/images/icons/5.png" alt="">
...
<!-- New Product Start -->
                ...
                <div class="new-product-wrapper swiper-wrapper">
                        ...
                        <div class="product">
                            <div class="thumb">
                                <a href="shop-left-sidebar.html" class="image">
                                    <img src="{{asset(env('THEME'))}}/images/product-image/1.jpg" alt="Product" />
                                    <img class="hover-image" src="{{asset(env('THEME'))}}/images/product-image/2.jpg" alt="Product" />
                                </a>
                                <span class="badges">
                    ...
                    <div class="new-product-item swiper-slide">
                        <div class="product">
                            <div class="thumb">
                                <a href="shop-left-sidebar.html" class="image">
                                    <img src="{{asset(env('THEME'))}}/images/product-image/3.jpg" alt="Product" />
                                    <img class="hover-image" src="{{asset(env('THEME'))}}/images/product-image/4.jpg" alt="Product" />
                                </a>
                                <span class="badges">
                                    <span class="new">New</span>
                                </span>
                    ...
                    <div class="new-product-item swiper-slide">
                        <div class="product">
                            <div class="thumb">
                                <a href="shop-left-sidebar.html" class="image">
                                    <img src="{{asset(env('THEME'))}}/images/product-image/5.jpg" alt="Product" />
                                    <img class="hover-image" src="{{asset(env('THEME'))}}/images/product-image/6.jpg" alt="Product" />
                                </a>
                                <span class="badges">
                                    <span class="new">New</span>
                                </span>
                    ...
                    <div class="new-product-item swiper-slide">
                        <div class="product">
                            <div class="thumb">
                                <a href="shop-left-sidebar.html" class="image">
                                    <img src="{{asset(env('THEME'))}}/images/product-image/7.jpg" alt="Product" />
                                    <img class="hover-image" src="{{asset(env('THEME'))}}/images/product-image/8.jpg" alt="Product" />
                                </a>
                                <span class="badges">
                                    <span class="new">New</span>
                                </span>
    ...
    <div class="section product-tab-area pb-100px">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center" data-aos="fade-up">
                    <div class="section-title mb-0">
                        <h2 class="title">Самый популярный товар</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="{{asset(env('THEME'))}}/images/instragram-image/1.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="{{asset(env('THEME'))}}/images/instragram-image/2.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-xs-30px" data-aos="fade-up" data-aos-delay="600">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="{{asset(env('THEME'))}}/images/instragram-image/3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 " data-aos="fade-up" data-aos-delay="800">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="{{asset(env('THEME'))}}/images/instragram-image/4.png" alt="">
                ...
                <div class="swiper-wrapper">
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset(env('THEME'))}}/images/blog-image/1.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset(env('THEME'))}}/images/blog-image/2.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset(env('THEME'))}}/images/blog-image/3.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset(env('THEME'))}}/images/blog-image/4.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                            <div class="single-wedge">
                                <h4 class="footer-herading">MiRus</h4>
                                <p class="about-text">
...
+38 (096) 000 0000
                                ...
                                <ul class="link-follow">
                                    <li class="li">
                                        <a class="icon-social-instagram icons" title="instagram" href="#"></a>
                                    </li>
                                    <li class="li">
                                        <a class="icon-social-facebook icons" title="facebook" href="#"></a>
                                    </li>
                                    <li class="li">
                                        <a class="icon-social-google icons" title="google" href="#"></a>
                                    </li>
                                    <li class="li">
                                        <a class="icon-social-youtube icons" title="youtube" href="#"></a>
                                    </li>
                                    <li class="li">
                                        <a class="icon-phone icons" title="phone" href="#"></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-3 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                            <div class="single-wedge">
                                <h4 class="footer-herading">О КОМПАНИИ</h4>
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="about.html">О нас</a></li>
                                            <li class="li"><a class="single-link" href="#">Контакты</a></li>
                                            <li class="li"><a class="single-link" href="privacy-policy.html">Вопросы и ответы</a></li>
                                            <li class="li"><a class="single-link" href="#">Статьи</a></li>
                                            <li class="li"><a class="single-link" href="#">Скидки и Акции</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-2 col-sm-6 mb-lm-30px" data-aos="fade-up" data-aos-delay="600">
                            <div class="single-wedge">
                                <h4 class="footer-herading">КЛИЕНТАМ</h4>
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="my-account.html">Доставка и оплата</a>
                                            </li>
                                            <li class="li"><a class="single-link" href="cart.html">Гарантия</a></li>
                                            <li class="li"><a class="single-link" href="login.html">Обмен и возврат</a></li>
                                            <li class="li"><a class="single-link" href="wishlist.html">Как оформить заказ</a></li>
                                            <li class="li"><a class="single-link" href="wishlist.html">Отзывы</a></li>
                                            <li class="li"><a class="single-link" href="wishlist.html">Обратная связь</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="800">
                            <div class="single-wedge">
                                <h4 class="footer-herading">ПОДПИШИТЕСЬ НА РАССЫЛКУ</h4>
                                <div class="footer-links">
                                    <!-- News letter area -->
                                            ...
                                            <div id="mc_embed_signup_scroll" class="mc-form">
                                                ...
                                                <div class="clear">
                                                    <button id="mc-embedded-subscribe" class="button btn-primary" type="submit" name="subscribe" value=""><i
                                                            class="icon-cursor"></i> Отправить</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div class="row flex-sm-row-reverse">
                        <div class="col-md-6 text-right">
                            <div class="payment-link">
                                <img src="{{asset(env('THEME'))}}/images/icons/payment.png" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 text-left">
                            <p class="copy-text">© 2016-2021 <a class="company-name" href="https://hasthemes.com/">
                                    Мирус</a>. Все Права Защищены</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12 mb-lm-30px mb-sm-30px">
                            ...
                            <div class="swiper-container gallery-top mb-4">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset(env('THEME'))}}/images/product-image/1.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset(env('THEME'))}}/images/product-image/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset(env('THEME'))}}/images/product-image/3.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset(env('THEME'))}}/images/product-image/4.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="{{asset(env('THEME'))}}/images/product-image/5.jpg" alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Vendor JS -->
    <!-- <script src="{{asset(env('THEME'))}}/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/vendor/popper.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/vendor/bootstrap.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/vendor/modernizr-3.11.2.min.js"></script> -->

    <!--Plugins JS-->
    <!-- <script src="{{asset(env('THEME'))}}/js/plugins/swiper-bundle.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/jquery-ui.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/jquery.nice-select.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/countdown.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/scrollup.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/jquery.waypoints.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/jquery.lineProgressbar.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/jquery.zoom.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/venobox.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/ajax-mail.js"></script> -->

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <script src="{{asset(env('THEME'))}}/js/vendor/vendor.min.js"></script>
    <script src="{{asset(env('THEME'))}}/js/plugins/plugins.min.js"></script>
